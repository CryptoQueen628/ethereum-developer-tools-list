...
#### Frameworks
* [Truffle Suite](http://truffleframework.com) - Most popular smart contract development, testing, and deployment framework. Truffle,      Ganache (personal blockchain) and Drizzle (front-end) make up the Truffle suite 
   https://media.consensys.net/truffle-deep-dive-what-you-need-to-know-when-developing-on-ethereum-e548d4df6e9
